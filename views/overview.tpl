...
<div class="w3-row">
  ...
  <div class="w3-row w3-xxlarge w3-bottombar w3-border-theme-dark-blue w3-margin-bottom"></div>
  <p style="text-indent:25px">Our mission is to help customers better manage their personal fitness goals. Imagine a world where you have an easy to use webapp that can help accomplish tasks such as: planning meals, counting calories, planning workout routines, and more. SWIFT embodies ideas such as wellness, health, and personal fulfillment. We are driven to create a quality experience that allows users to succeed in their everyday fitness endeavors. All of this and more when you use SWIFT.</p>
